class employeeInfoPage {
    ...
    fillEmpInfo(infoData: any) {
        ...
        this.elements.selectInputs().eq(0).click().contains(infoData.Nationality).click({ force: true })
        this.elements.selectInputs().eq(1).click().contains(infoData.MaritalStatus).click({ force: true })
        ...
        this.elements.empLoader().should('not.exist')
        this.elements.selectInputs().eq(0).click().contains(infoData.JobTitle).click({ force: true })
        this.elements.selectInputs().eq(2).click().contains(infoData.SubUnit).click({ force: true })
        this.elements.selectInputs().eq(4).click().contains(infoData.Status).click({ force: true })
